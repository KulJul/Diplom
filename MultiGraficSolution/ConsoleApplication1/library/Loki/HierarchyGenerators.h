...
////////////////////////////////////////////////////////////////////////////////
    ...
    template <> 
    struct GenScatterHierarchyHelper1<TL::nullptr_tag>
    {
        template <class TList, template <typename> class Unit>
        struct In { struct Result {}; };        
    };
    ...
    template <> 
    struct GenScatterHierarchyHelper2<TL::nullptr_tag>
    {
        template <class TList, template <typename> class Unit>
        struct In { struct Result {}; };        
    };
...
////////////////////////////////////////////////////////////////////////////////
    ...
    template <> 
    struct GenLinearHierarchyHelper<TL::nullptr_tag>
    {
        template<class TList, template <class, class> class Unit, class Root>
        struct In
        {
    ...
    {
        ASSERT_TYPELIST(TList); // TList must not be nullptr
